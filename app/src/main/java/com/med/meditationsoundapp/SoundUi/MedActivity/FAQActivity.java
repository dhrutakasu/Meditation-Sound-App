...
public class FAQActivity extends AppCompatActivity {
    ...
    private void initActions() {
        ...
        if (MedConstants.isConnectingToInternet(context)) {
            MedAd_Banner.getMedInstance().showBannerAds(FAQActivity.this, AdSize.LARGE_BANNER, (RelativeLayout) findViewById(R.id.RlMedBannerAdView), (RelativeLayout) findViewById(R.id.RlMedBannerAd));
        }
